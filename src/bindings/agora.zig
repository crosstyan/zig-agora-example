...
pub const ERR_OKAY: c_int = 0;
pub const ERR_FAILED: c_int = 1;
pub const ERR_NET_DOWN: c_int = 14;
pub const ERR_JOIN_CHANNEL_REJECTED: c_int = 17;
pub const ERR_INVALID_APP_ID: c_int = 101;
pub const ERR_INVALID_CHANNEL_NAME: c_int = 102;
pub const ERR_NO_SERVER_RESOURCES: c_int = 103;
pub const ERR_LOOKUP_CHANNEL_REJECTED: c_int = 105;
pub const ERR_OPEN_CHANNEL_REJECTED: c_int = 107;
pub const ERR_TOKEN_EXPIRED: c_int = 109;
pub const ERR_INVALID_TOKEN: c_int = 110;
pub const ERR_DYNAMIC_TOKEN_BUT_USE_STATIC_KEY: c_int = 115;
pub const ERR_SET_CLIENT_ROLE_NOT_AUTHORIZED: c_int = 119;
pub const ERR_DECRYPTION_FAILED: c_int = 120;
pub const ERR_OPEN_CHANNEL_INVALID_TICKET: c_int = 121;
pub const ERR_OPEN_CHANNEL_TRY_NEXT_VOS: c_int = 122;
pub const ERR_CLIENT_IS_BANNED_BY_SERVER: c_int = 123;
pub const ERR_SEND_VIDEO_OVER_BANDWIDTH_LIMIT: c_int = 200;
pub const ERR_AUDIO_DECODER_NOT_MATCH_AUDIO_FRAME: c_int = 201;
pub const ERR_NO_AUDIO_DECODER_TO_HANDLE_AUDIO_FRAME: c_int = 202;
pub const agora_err_code_e = c_uint;
pub const USER_OFFLINE_QUIT: c_int = 0;
pub const USER_OFFLINE_DROPPED: c_int = 1;
pub const user_offline_reason_e = c_uint;
pub const VIDEO_DATA_TYPE_YUV420: c_int = 0;
pub const VIDEO_DATA_TYPE_H264: c_int = 2;
pub const VIDEO_DATA_TYPE_H265: c_int = 3;
pub const VIDEO_DATA_TYPE_GENERIC: c_int = 6;
pub const VIDEO_DATA_TYPE_GENERIC_JPEG: c_int = 20;
pub const video_data_type_e = c_uint;
pub const VIDEO_FRAME_AUTO_DETECT: c_int = 0;
pub const VIDEO_FRAME_KEY: c_int = 3;
pub const VIDEO_FRAME_DELTA: c_int = 4;
pub const video_frame_type_e = c_uint;
pub const VIDEO_FRAME_RATE_FPS_1: c_int = 1;
pub const VIDEO_FRAME_RATE_FPS_7: c_int = 7;
pub const VIDEO_FRAME_RATE_FPS_10: c_int = 10;
pub const VIDEO_FRAME_RATE_FPS_15: c_int = 15;
pub const VIDEO_FRAME_RATE_FPS_24: c_int = 24;
pub const VIDEO_FRAME_RATE_FPS_30: c_int = 30;
pub const VIDEO_FRAME_RATE_FPS_60: c_int = 60;
pub const video_frame_rate_e = c_uint;
pub const VIDEO_STREAM_HIGH: c_int = 0;
pub const VIDEO_STREAM_LOW: c_int = 1;
pub const video_stream_type_e = c_uint;
pub const video_frame_info_t = extern struct {
    data_type: video_data_type_e,
    stream_type: video_stream_type_e,
    frame_type: video_frame_type_e,
    frame_rate: video_frame_rate_e,
};
pub const AUDIO_CODEC_DISABLED: c_int = 0;
pub const AUDIO_CODEC_TYPE_OPUS: c_int = 1;
pub const AUDIO_CODEC_TYPE_G722: c_int = 2;
pub const AUDIO_CODEC_TYPE_G711A: c_int = 3;
pub const AUDIO_CODEC_TYPE_G711U: c_int = 4;
pub const audio_codec_type_e = c_uint;
pub const AUDIO_DATA_TYPE_OPUS: c_int = 1;
pub const AUDIO_DATA_TYPE_OPUSFB: c_int = 2;
pub const AUDIO_DATA_TYPE_PCMA: c_int = 3;
pub const AUDIO_DATA_TYPE_PCMU: c_int = 4;
pub const AUDIO_DATA_TYPE_G722: c_int = 5;
pub const AUDIO_DATA_TYPE_AACLC: c_int = 8;
pub const AUDIO_DATA_TYPE_HEAAC: c_int = 9;
pub const AUDIO_DATA_TYPE_PCM: c_int = 100;
pub const AUDIO_DATA_TYPE_GENERIC: c_int = 253;
pub const audio_data_type_e = c_uint;
pub const audio_frame_info_t = extern struct {
    data_type: audio_data_type_e,
};
pub const RTC_LOG_DEFAULT: c_int = 0;
pub const RTC_LOG_EMERG: c_int = 1;
pub const RTC_LOG_ALERT: c_int = 2;
pub const RTC_LOG_CRIT: c_int = 3;
pub const RTC_LOG_ERROR: c_int = 4;
pub const RTC_LOG_WARNING: c_int = 5;
pub const RTC_LOG_NOTICE: c_int = 6;
pub const RTC_LOG_INFO: c_int = 7;
pub const RTC_LOG_DEBUG: c_int = 8;
pub const rtc_log_level_e = c_uint;
pub const AREA_CODE_DEFAULT: c_int = 0;
pub const AREA_CODE_CN: c_int = 1;
pub const AREA_CODE_NA: c_int = 2;
pub const AREA_CODE_EU: c_int = 4;
pub const AREA_CODE_AS: c_int = 8;
pub const AREA_CODE_JP: c_int = 16;
pub const AREA_CODE_IN: c_int = 32;
pub const AREA_CODE_OC: c_int = 64;
pub const AREA_CODE_SA: c_int = 128;
pub const AREA_CODE_AF: c_int = 256;
pub const AREA_CODE_KR: c_int = 512;
pub const AREA_CODE_OVS: c_uint = 4294967294;
pub const AREA_CODE_GLOB: c_uint = 4294967295;
pub const area_code_e = c_uint;
pub const log_config_t = extern struct {
    log_disable: bool,
...
pub const audio_codec_option_t = extern struct {
    audio_codec_type: audio_codec_type_e,
    pcm_sample_rate: c_int,
    pcm_channel_num: c_int,
};
pub const rtc_channel_options_t = extern struct {
...
pub const CLOUD_PROXY_NONE: c_int = 0;
pub const CLOUD_PROXY_UDP: c_int = 1;
pub const CLOUD_PROXY_TCP: c_int = 3;
pub const CLOUD_PROXY_AUTO: c_int = 100;
pub const cloud_proxy_type_e = c_uint;
pub const NETWORK_EVENT_DOWN: c_int = 0;
pub const NETWORK_EVENT_UP: c_int = 1;
pub const NETWORK_EVENT_CHANGE: c_int = 2;
pub const network_event_type_e = c_uint;
pub const connection_id_t = u32;
pub const connection_info_t = extern struct {
    conn_id: connection_id_t,
    uid: u32,
    channel_name: [65]u8,
};
pub const agora_rtc_event_handler_t = extern struct {
...
pub const rtm_event_type_e = c_uint;
pub const ERR_RTM_OK: c_int = 0;
pub const ERR_RTM_FAILED: c_int = 1;
pub const ERR_RTM_LOGIN_REJECTED: c_int = 2;
pub const ERR_RTM_INVALID_RTM_UID: c_int = 3;
pub const ERR_RTM_LOGIN_INVALID_TOKEN: c_int = 5;
pub const ERR_RTM_LOGIN_NOT_AUTHORIZED: c_int = 7;
pub const ERR_RTM_INVALID_APP_ID: c_int = 101;
pub const WARN_RTM_LOOKUP_CHANNEL_REJECTED: c_int = 105;
pub const ERR_RTM_TOKEN_EXPIRED: c_int = 109;
...
pub extern fn agora_rtc_logout_rtm() c_int;
pub extern fn agora_rtc_send_rtm_data(rtm_uid: [*c]const u8, msg_id: u32, msg: ?*const anyopaque, msg_len: usize) c_int;
...
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token '##'"); // /usr/local/lib/zig/include/stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token '##'"); // /usr/local/lib/zig/include/stdint.h:282:9
pub const __uint_c = @compileError("unable to translate macro: undefined identifier `U`"); // /usr/local/lib/zig/include/stdint.h:284:9
pub const __INTN_MIN = @compileError("unable to translate macro: undefined identifier `INT`"); // /usr/local/lib/zig/include/stdint.h:776:10
pub const __INTN_MAX = @compileError("unable to translate macro: undefined identifier `INT`"); // /usr/local/lib/zig/include/stdint.h:777:10
pub const __UINTN_MAX = @compileError("unable to translate macro: undefined identifier `UINT`"); // /usr/local/lib/zig/include/stdint.h:778:9
pub const __INTN_C = @compileError("unable to translate macro: undefined identifier `INT`"); // /usr/local/lib/zig/include/stdint.h:779:10
pub const __UINTN_C = @compileError("unable to translate macro: undefined identifier `UINT`"); // /usr/local/lib/zig/include/stdint.h:780:9
...
pub const __agora_api__ = "";
pub const AGORA_RTC_CHANNEL_NAME_MAX_LEN = @as(c_int, 64);
pub const AGORA_RTC_USER_ID_MAX_LEN = @as(c_int, 255);
pub const AGORA_RTC_PRODUCT_ID_MAX_LEN = @as(c_int, 63);
pub const AGORA_RTM_UID_MAX_LEN = @as(c_int, 64);
pub const AGORA_RTM_DATA_MAX_LEN = @as(c_int, 32) * @as(c_int, 1024);
pub const AGORA_CREDENTIAL_MAX_LEN = @as(c_int, 256);
pub const AGORA_CERTIFICATE_MAX_LEN = @as(c_int, 1024);
pub const AGORA_LICENSE_VALUE_LEN = @as(c_int, 32);
pub const CONNECTION_ID_ALL = @import("std").zig.c_translation.cast(connection_id_t, @as(c_int, 0));
pub const CONNECTION_ID_INVALID = @import("std").zig.c_translation.cast(connection_id_t, -@as(c_int, 1));
